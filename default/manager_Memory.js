...
function manageMemory_queues(){
    ...
    if(!Memory.spawnerRooms){
        Memory.spawnerRooms = [];
        init_spawnerRooms("E53N22");      //#### WILL NEED TO CLEVERLY CHECK WHEN TO MAKE THIS DEPENDING ON WHAT IS BEING ASKED TO BE SPAWNED, NEED TO CHECK IF THIS QUEUE FOR THIS ROOM ALREADY EXISTS
    }
