                ...
                for(sourceIndex in Memory.energyRooms[energyRoomIndex].sources) {   // Go through each source and try create a miner+gatherer combo for it
                    ...
                    for(condition in creepQueuePriority) {
                        const creepParts = this.fetch_creepParts(
                            ...
                            additionalInfo={
                                containerNumber: Memory.energyRooms[roomIndex].source[sourceIndex].containers.length,
                                minerNumber: Memory.energyRooms[roomIndex].source[sourceIndex].miners.length,
                                freeSpace: Memory.energyRooms[roomIndex].source[sourceIndex].free,
                            }
                        );
                        if(creepParts!=null) {
