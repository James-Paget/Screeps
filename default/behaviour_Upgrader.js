...
var upgrading_tasks = {
    ...
    queue : function(roomID){
        ...
        var creepSpec = {roomID:roomID, sourceID:null, parts:[WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], role:"Upgrader", time:Game.time};
